...
## of a matrix rather than compute it repetely. The following two functions can be used to cache the inverse
## of a matrix. 
...
## This function computes the inverse of the speical "matrix" returned by makeCacheMatrix above. If the 
